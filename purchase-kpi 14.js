...
.pkpi-charts{display:grid;grid-template-columns:repeat(auto-fit,minmax(440px,1fr));gap:14px}
...
.pkpi-chart-card .cwrap{position:relative;height:340px}
...
#page-purchase-kpi{max-width:1160px;margin-inline:auto}
