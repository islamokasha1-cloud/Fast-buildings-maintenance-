...
# ⚠⚠ **ورشِّح شكلَ مجلّد التصدير قبل الفرز.** ختمُ البروفات أنشأ `_drills/` في
#    الحاوية نفسِها، و`_` **يسبق الأرقام في الفرز التنازليّ** — فصار «أحدثُ تصدير»
#    يشير إلى مجلّد الختم: لا ملفَّ فهرسَ فيه ولا تاريخَ يُفكَّك. **ميزةُ الرقابة
#    كسرت كاشفَ التصدير.** والترشيحُ بالشكل يجعل الكاشفَ لا يبالي بما يُضاف حولَه.
