#!/usr/bin/env bash
# ============================================================================
#  سدُّ فجوةِ النسخ الاحتياطي لـ Cloud Storage — الإعدادُ الكامل
...
#
#  التشغيل (من Cloud Shell — يحتاج صلاحيةَ owner على المشروعين):
#      bash scripts/storage-backup-setup.sh
...
# ============================================================================
#  الطبقةُ ١ — داخلَ الحاوية المصدر (آليةُ التعافي اليومية)
...
# ============================================================================
#  الطبقةُ ٢ — حاويةٌ ثانيةٌ في مشروعٍ منفصلٍ وإقليمٍ آخر (الكارثة)
# ============================================================================
...
if gcloud transfer jobs describe "$JOB_NAME" --project="$VAULT_PROJECT" \
  ...
  # **بلا --delete-from**: التطبيقُ يحذف ملفّاتٍ في سياقه الطبيعيّ
