...
/* تسميةُ نوعية العمل **في الرسائل** — قائمةٌ مغلقةٌ دائماً، و«أخرى» تبقى «أخرى».
   كانت تُرجع النصَّ الحرَّ الذي يكتبه مسؤولُ الموارد البشرية في خانة «أخرى» — وهو
   **عينُ ما استُثني له «البيانُ المختصر» من كلّ خانةٍ في القالبين**: نصٌّ حرٌّ قد
   يحمل اسمَ موظّف («تجديد إقامة فلان»). فكانت القاعدةُ محروسةً في بابٍ ومفتوحةً في
   بابٍ آخرَ يؤدّي إلى المكان نفسِه.
   وداخلَ النظام يبقى النصُّ كاملاً — وحدةُ السداد وجرسُها لا يفتحهما إلا صاحبُ
   الصلاحية (`workTypeLabel` في `hr-payments.js` بلا تغيير). أمّا الرسالةُ فتخرج
   إلى جوّالٍ وتمرّ بخوادم Meta وتبقى في سجلّ المحادثة — فلا تحمل اسماً.
   ولا خانةَ تفرغ بذلك: «أخرى» قيمةٌ نصّيةٌ في `HRP_WORK_TYPES` (وMeta ترفض الخانةَ
   الفارغة)، والتفصيلُ يُقرأ من الطلب نفسِه بزرّ «فتح الطلب». */
